...
#define AST_CALLID_BUFFER_LENGTH 13
	...
	*/
	...
	<VITEL> void __attribute__((format(printf, 8, 9))) ast_vitel_log(const char *funcName, const char *callid, const char *src, const char *dst, const char *exten, const char *event, const char *data, const char *fmt, ...);
	</ VITEL>
